        ...
        <style>
          ...
          * {
          ...
          .play-btn {
              ...
              min-width: 30px;
              height: 30px;
              background: url("audio-icon-play.png") 0 center/500% 100% no-repeat;
              appearance: none;
              border: none;
          ...
          .play-btn.playing {
              background: url("audio-icon-play.png") 25% center/500% 100% no-repeat;
          }
          ...
          .volume-bar {
              ...
              min-width: 30px;
              height: 30px;
              background: url("audio-icon-play.png") 50% center/500% 100% no-repeat;
              position: relative;
          }
          
          .volume-bar.half {
              background: url("audio-icon-play.png") 75% center/500% 100% no-repeat;
          }
          .volume-bar.over {
              background: url("audio-icon-play.png") 100% center/500% 100% no-repeat;
          }
